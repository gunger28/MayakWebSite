            ...
            <div class="information__wrapper">
                <div class="wrapper__left">
                    <div class="left__img-block">
                        <img src="/assets/img/Dissol_1.png" alt="картинка" />

                        <div class="harakteristics">
                        <div class="block_Individ">Индивидуальная конструкция</div>
                        <div class="block_har">Объем бака: 180 л</div>
<div class="block_har">Кол. оборотов/мин: 3000</div>
<div class="block_har">Сеть: 380 В</div>
<div class="block_har">Частотный преобразователь</div>
                    ...
                    <div class="left__text-block">
                        ...
                        <p class="text__text">
                        Предназначен для смешения материалов средней твердости в жидких средах. Диссольвер применяется для производства красок, клеев, косметических продуктов, различных паст, дисперсий и эмульсий и т. д. Диссольверы могут оснащаться рубашкой для обогрева или охлаждения. Детали и узлы, соприкасающиеся с продуктом выполнены из нержавеющей стали.

В дисольверах применяются мешалки различных типов: 
<p class="text__text">
-Рамная мешалка диссольвера работает как скребок и не позволяет липким и густым веществам оседать на дне и стенках.</p>
<p class="text__text">
-быстроходная типа фрезы, измельчает и тщательно перемешивает сырье до получения однородной массы компонентов лакокрасочного материала.
</p>
                        </p>
                        <p class="stats">
                        Объем: до 1500л.
